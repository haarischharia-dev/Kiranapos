...
const styles = StyleSheet.create({
  ...
  tilePressed: { backgroundColor: '#fdebdf', borderColor: '#ff9933' },
  tileName: { fontSize: 14, fontFamily: 'WorkSans_600SemiBold', color: '#231a13', textAlign: 'center', marginBottom: 4 },
  tilePrice: { fontSize: 12, fontFamily: 'JetBrainsMono_700Bold', color: '#8f4e00' },
  addTile: { backgroundColor: '#fff1e8', borderColor: '#ff9933', borderStyle: 'dashed', borderWidth: 2 },
  addTileIcon: { fontSize: 26, color: '#8f4e00', fontWeight: 'bold', marginBottom: 2 },
  addTileText: { fontSize: 12, fontFamily: 'ArchivoNarrow_700Bold', color: '#8f4e00', textAlign: 'center' },
  modalOverlay: { flex: 1, justifyContent: 'flex-end', backgroundColor: 'rgba(26, 43, 60, 0.6)' },
  modalContent: { backgroundColor: '#ffffff', padding: 24, borderTopLeftRadius: 16, borderTopRightRadius: 16, borderWidth: 3, borderColor: '#1a2b3c' },
  modalTitle: { fontSize: 22, fontFamily: 'Anybody_700Bold', marginBottom: 20, color: '#231a13' },
  input: {
    borderWidth: 2,
    borderColor: '#dbc2b0',
    borderRadius: 8,
  ...
  unitBtn: { flex: 1, padding: 10, borderWidth: 2, borderColor: '#dbc2b0', alignItems: 'center' },
  unitBtnActive: { backgroundColor: '#ff9933', borderColor: '#693800' },
  unitBtnText: { fontSize: 16, fontFamily: 'WorkSans_500Medium', color: '#231a13' },
  unitBtnTextActive: { color: '#1a2b3c', fontFamily: 'ArchivoNarrow_700Bold' },
  row: { flexDirection: 'row' },
  flex1: { flex: 1 },
  spacer: { width: 16 },
  label: { fontSize: 12, fontFamily: 'ArchivoNarrow_700Bold', color: '#554336', marginBottom: 4, textTransform: 'uppercase' },
});
